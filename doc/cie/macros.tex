...
\newcommand{\ipcases}[7]{\textsf{match}\,#1\,\textsf{with}\,\iinj{#2}{#3}{\Rightarrow}{#4}\,|\cdots|\iinj{#5}{#6}{\Rightarrow}{#7}}
\newcommand{\ipcase}[7]{\textsf{match}\,#1\,\textsf{with}\,\iinj{#2}{#3}{\Rightarrow}{#4}\,|\,\iinj{#5}{#6}{\Rightarrow}{#7}}
...
\newcommand{\osumty}[4]{`#1\,\mathsf{of}\,#2 + \cdots + `#3\,\mathsf{of}\,#4}
\newcommand{\osumtyx}[4]{`#1\,\mathsf{of}\,#2 + `#3\,\mathsf{of}\,#4}
...
\newcommand{\opcase}[7]{\mathsf{match}\,#1\,\mathsf{with}\,\oinj{#2}{#3}{\Rightarrow}{#4}\,|\,\oinj{#5}{#6}\Rightarrow{#7}}
\newcommand{\opcases}[7]{\mathsf{match}\,#1\,\mathsf{with}\,\oinj{#2}{#3}\Rightarrow{#4}\,|\cdots\,|\oinj{#5}{#6}\Rightarrow{#7}}
