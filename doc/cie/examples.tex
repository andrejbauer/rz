...
Assertion continuity =
  \iForall (f:\iT{(nat \iTo nat) \iTo nat}, a:\iTo{nat \iTo nat}),
    let p = continuity f a in p : \iTo{nat} \iAnd
    (\iForall (b:\iTo{nat \iTo nat}),
       (\iForall (m:\iTo{nat}),  m \iLeq p \iTo a m \iPer{nat} b m) \iTo f a \iPer{nat} f b)
\end{source}
%
