...
\iParameter{\f{s}}{\iSet}.\\
\iAxiom{\f{eq}}{\forall \f{x},\f{y}:\f{s}.\ \f{x} = \f{y} \lor \lnot(\f{x} = \f{y})}.\\
\end{showInputSmall}%
%
that the realizer for the axiom $\mathtt{eq}$ is specified by
%
\begin{showOutputSmall}
\ovalspec{\f{eq}}{\oarrow{\oarrow{\f{s}}{\f{s}}}{`\texttt{or0}+`\texttt{or1}}}\\
...
%
\begin{showInputSmall}
\iDefinition{\f{nonZeroReal}}{\isubset{x}{\f{real}}{\lnot(\f{x}=\f{zero})}}.\\
\iParameter{\f{inv}}{\f{nonZeroReal}\to\f{real}}.\\
\iAxiom{\f{inverse}}{\forall\f{x}:\f{real}.\ \lnot(\f{x}=\f{zero}) \Rightarrow \f{x}\,\f{*}\,(\f{inv\ x}) = \f{one}}.\\
\iDefinition{\f{(/)}\ (\f{x}:\f{real})\ (\f{y}:\f{nonZeroReal})} {\f{x}\,\f{*}\,(\f{inv\ y})}.\\
...
%
\begin{showOutput}
\f{inv} (\ooblig{\f{u}}{\ounit}{\onot{(\oper{\f{real}}{\f{x}}{\f{zero}})}}{(\f{x},\f{u})})
...
\iflong
\begin{showOutput}
\f{inv} (\oobligx{\onot{(\oper{\f{real}}{\f{x}}{\f{zero}})}}{\f{x}})
...
%
\begin{showOutput}
\oassertion{\f{inverse}}{
\oforallt{\f{x}}{\f{real}}{\oimply{
\onot{(\oper{\f{real}}{\f{x}}{\f{zero}})}
}{
\oper{\f{real}}{\f{x * inv\ x}}{\f{one}}
}}
}
%(**  Assertion inverse =
...
\begin{figure}
\begin{showInput}
\iDefinition{\f{Branching}}{\f{thy}}\\
\qquad\iParameter{\f{s}}{\iSet} \qquad\mbox{\texttt{(* branching types *)}}\\
\qquad\iParameter{\f{t}}{\f{s}\to\iSet}\qquad \mbox{\texttt{(* branch labels *)}}\\
\f{end}.\\
\\
\iParameter{\f{W}}{(\f{B} : \f{Branching}) \to \f{thy}}\\
\qquad\iParameter{\f{w}}{\iSet}.\\
\qquad\iParameter{\f{tree}}{(\f{x} : \f{B.s})\to (\f{B.t\ x}\to \f{w})\to \f{w}.}\\
\qquad\iAxiom{\f{induction}}{}\\
\qquad\qquad{\forall\f{M} : \f{thy}\ \iParameter{\f{p}}{\f{w}\to\iProp}\ \f{end}.\ }\\
...
%
\begin{showInput}
\iParameter{\f{a\ b}}{\iSet}.\\
\iParameter{\f{r}}{\f{a}\to\f{b}\to\iProp}.\\
\iAxiom{\f{ac}}{(\forall \f{x}{:}\f{a}.\ \exists \f{y}{:}\f{b}.\ \f{r\ x\ y}) \Rightarrow 
                     (\exists \f{c}{:}{\f{a}\to\f{b}}.\ \forall \f{x}{:}{\f{a}}.\ \f{r}\ \f{x}\ (\f{c\ x}))}.
\end{showInput}
%
...
\iParameter{\f{r}}{\f{a}\to\f{b}\to\iProp}.\\
\iAxiom{\f{ac}}{(\forall \f{x}{:}\f{a}.\ \exists \f{y}{:}\f{b}.\ \f{r\ x\ y}) \Rightarrow 
                     (\exists \f{c}{:}{\irz{\f{a}}\to\f{b}}.\ \forall \f{x}{:}{\irz{\f{a}}}.\ \f{r}\ (\irz{\f{x}})\ (\f{c\ x}))}.
\end{showInput}
Now the output is
%
\begin{source}
...
\begin{showInput}
\iAxiom{\f{continuity}}{}\\
\qquad  {\forall \f{f}{:}(\f{nat}{\to}\f{nat}){\to}\f{nat}.\   \forall \f{a}{:}\f{nat}{\to}{\f{nat}}}\\
\qquad\qquad
    \exists \f{k}{:}\f{nat}.\ 
