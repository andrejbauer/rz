...
\internal{Andrej}{I am afraid the Kuratowski example has changed so
  the examples below are not in sync with the example. Will try to
...
%
\internal{Chris}{Except that phase-splitting breaks this invariant.
  Oops.}
%
\internal{Chris}{Term-level simplifications include \ldots}
%
