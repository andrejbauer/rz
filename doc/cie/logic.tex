...
\begin{figure}[htbp]
	\internal{CS}{This isn't a good example; it exercises the source language, but doesn't have model parameters and doesn't translate into anything very interesting, it seems.  I think I'd prefer finite sets.}
\begin{alltt}
Definition Metric :=
