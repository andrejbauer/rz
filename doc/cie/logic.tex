...
Figure~\ref{fig:kuratowski} shows a sample input for the RZ system. 
...
model choosing an implementation of a single set. For any such model
$\im$, then, $\mathtt{K}(\im)$ is a theory describing a model of
finite sets whose elements are in the set $\iselect{\im}{\mathtt{a}}$.
Alternatively, a theory can describe a uniform family of models (e.g.,
...
this should be familiar, including the use of lambda abstraction are
