...
RZ ever outputs only a small subset of Ocaml types (the unit type,
...
$\oobligx{\op}{\oe}$ is a shorthand for
$\ooblig{\_}{\ounit}{\op}{\oe}$.
...
built are observatinal equality $\oequal{\oe_1}{\oe_2}$ and pers
$\oper{s}{\oe_1}{\oe_2}$. The formula $\ototal{\oe}{\os}$ stands for
...
\internal{Andrej}{Actually, I don't think another example is going to
  be very useful here because it would require us to say something
  about the input langauge (or be totally boring).}
