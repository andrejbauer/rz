...
\begin{figure}
  ...
  \begin{array}{rl@{\qquad}l}
    ...
    | & \orz{\oe_1}{\oapp{\oP}{\oe_2}} & \mbox{Realizers of atomic propositions}\\
...
$\oper{s}{\oe_1}{\oe_2}$ on abstract types, and statements
$\orz{\oe_1}{\oapp{\oP}{\oe_2}}$ which mean ``$\oe_1$ realizes
$\oapp{\oP}{\oe_2}$'' where~$\oP$ is an atomic predicate.
The formula $\ototal{\oe}{\os}$ stands for $\oper{\os}{\oe}{\oe}$,
while $\oforallt{\ox}{\os}{\op}$ is a shorthand for
