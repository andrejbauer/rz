...
\end{equation*}
%
requires that the programer define a local value~$y$ such that
$\phi(x^2+y^2)$ holds. In principle, local specifications could be
expressed as global ones, but at a significant cost to clarity and
verbosity.
