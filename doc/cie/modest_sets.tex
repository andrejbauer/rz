...
there are invariants and conditions that are not expressed by the type, such as:
%
\begin{enumerate}
...
assigned a set of \emph{realizers} that can be thought of as
...
last example. Propositions that are free of any computational content
