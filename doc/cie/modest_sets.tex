...
for useless code, so RZ has a subkind $\iStable \subseteq \iProp$ of
stable propositions which allows us to declare a computationally
irrelevant basic proposition. In the translation there is a
\emph{thinning} phase, see Section~\ref{sec:translation}, which
optimizes away specifications for computationally irrelevant
realizers.
