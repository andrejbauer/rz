...
\subsection{Relationship with other models of computation}
\label{sec:relat-with-other}

\internal{AB}{This might fit better at the end of the paper, but for the CCA
audience it's good that they see it early, because it will help them
imagine things more easily.}



\subsection{Examples of modest sets}
