...
\newcommand{\includeexample}[1]{
   ...
   \VerbatimInput[%frame=single,
                  ...
                  %framesep=5mm,
                  obeytabs=true,showtabs=true]{../../examples/#1}}
...
\item \LET \Param \PERCENT \metav{longrelationname} \EQUALS \Term \IN \Term\\
  ...
  \textbf{Question: Why is this less troublesome than adding
    \Verb|any| (or at least \Verb|any| $\cdots$ \Verb|in|) ?}
...
\includeexample{nat.thr}

\clearpage
\includeexample{semilattice.thr}

\clearpage
\includeexample{kuratowski2.thr}
Need to change brackets to parentheses

\clearpage
\includeexample{sums.thr}
\includeexample{subset.thr}

\clearpage
\includeexample{field.thr}

\clearpage
\includeexample{choice.thr}
This doesn't look right:  Aren't relations automatically uncurried?
